...
title: "系统设计入门"
slug: "system-design"
date: "2018-03-05T19:47"
tags: ["design"]
description: "学习如何设计大型系统。"
---
...
<p align="center"><img src="/img/system-design/jj3A5N8.png"><br></p>
...
<p align="center"><img src="/img/system-design/zdCAkB3.png"><br></p>

这里提供的[抽认卡堆](https://apps.ankiweb.net/)使用间隔重复的方法，帮助你记忆关键的系统设计概念。

-   [系统设计的卡堆](https://github.com/donnemartin/system-design-primer/blob/master/resources/flash_cards/System%20Design.apkg)
-   [系统设计的练习卡堆](https://github.com/donnemartin/system-design-primer/blob/master/resources/flash_cards/System%20Design%20Exercises.apkg)
-   [面向对象设计的练习卡堆](https://github.com/donnemartin/system-design-primer/blob/master/resources/flash_cards/OO%20Design.apkg)

随时随地都可使用。

### 代码资源：互动式编程挑战 {#代码资源：互动式编程挑战}

你正在寻找资源以准备[**编程面试**](https://github.com/donnemartin/interactive-coding-challenges)吗？

<p align="center"><img src="/img/system-design/b4YtAEN.png"><br></p>
...
<p align="center"><img src="/img/system-design/jrUBAF7.png"><br></p>
...
![Imgur](/img/system-design/OfVllex.png)
...
| 阅读 [真实架构](#真实架构) | :+1: | :+1: | :+1: |
| 复习 [如何处理一个系统设计面试题](#如何处理一个系统设计的面试题) | :+1: | :+1: | :+1: |
...
| 问题 |  |
| --- | --- |
| 设计 Pastebin.com (或者 Bit.ly) | [解答](https://github.com/donnemartin/system-design-primer/blob/master/solutions/system_design/pastebin/README.md) |
...
![Imgur](/img/system-design/4edXG0T.png)
...
![Imgur](/img/system-design/V5q57vU.png)
...
![Imgur](/img/system-design/cdCv5g7.png)
...
![Imgur](/img/system-design/4j99mhe.png)
...
![Imgur](/img/system-design/MzExP06.png)
...
![Imgur](/img/system-design/jj3A5N8.png)
...
### 第一步：回顾可扩展性（scalability）的视频讲座 {#第一步：回顾可扩展性（scalability）的视频讲座}
...
如果服务**性能**的增长与资源的增加是成比例的，服务就是可扩展的。通常，提高性能意味着服务于更多的工作单元，另一方面，当数据集增长时，同样也可以处理更大的工作单位。<sup><a href="http://www.allthingsdistributed.com/2006/03/a_word_on_scalability.html" target="_blank" rel="noopener">1</a></sup>
...
<p align="center"><img src="/img/system-design/bgLMI2u.png"><br><strong><a href="http://robertgreiner.com/2014/08/cap-theorem-revisited" target="_blank" rel="noopener">来源：再看 CAP 理论</a></strong></p>
...
<p align="center"><img src="/img/system-design/IOyLj4i.jpg"><br><strong><a href="http://www.slideshare.net/srikrupa5/dns-security-presentation-issa" target="_blank" rel="noopener">来源：DNS 安全介绍</a></strong></p>
...
<p align="center"><img src="/img/system-design/h9TAuGI.jpg"><br><strong><a href="https://www.creative-artworks.eu/why-use-a-content-delivery-network-cdn/" target="_blank" rel="noopener">来源：为什么使用 CDN</a></strong></p>
...
### CDN 推送（push） {#CDN-推送（push）}

当你服务器上内容发生变动时，推送 CDN 接受新内容。直接推送给 CDN 并重写 URL 地址以指向你的内容的 CDN 地址。你可以配置内容到期时间及何时更新。内容只有在更改或新增是才推送，流量最小化，但储存最大化。

### CDN 拉取（pull） {#CDN-拉取（pull）}
...
<p align="center"><img src="/img/system-design/h81n9iK.png"><br><strong><a href="http://horicky.blogspot.com/2010/10/scalable-system-design-patterns.html" target="_blank" rel="noopener">来源：可扩展的系统设计模式</a></strong></p>
...
<p align="center"><img src="/img/system-design/n41Azff.png"><br><strong><a href="https://upload.wikimedia.org/wikipedia/commons/6/67/Reverse_proxy_h2g2bob.svg" target="_blank" rel="noopener">资料来源：维基百科</a></strong><br></p>
...
<p align="center"><img src="/img/system-design/yB5SYwm.png"><br><strong><a href="http://lethain.com/introduction-to-architecting-systems-for-scale/#platform_layer" target="_blank" rel="noopener">资料来源：可缩放系统构架介绍</a></strong></p>
...
<p align="center"><img src="/img/system-design/Xkm5CXz.png"><br><strong><a href="https://www.youtube.com/watch?v=vg5onp8TU6Q" target="_blank" rel="noopener">资料来源：扩展你的用户数到第一个一千万</a></strong></p>
...
<p align="center"><img src="/img/system-design/C9ioGtn.png"><br><strong><a href="http://www.slideshare.net/jboner/scalability-availability-stability-patterns/" target="_blank" rel="noopener">资料来源：可扩展性、可用性、稳定性、模式</a></strong></p>
...
<p align="center"><img src="/img/system-design/krAHLGg.png"><br><strong><a href="http://www.slideshare.net/jboner/scalability-availability-stability-patterns/" target="_blank" rel="noopener">资料来源：可扩展性、可用性、稳定性、模式</a></strong></p>
...
<p align="center"><img src="/img/system-design/U3qV33e.png"><br><strong><a href="https://www.youtube.com/watch?v=vg5onp8TU6Q" target="_blank" rel="noopener">资料来源：扩展你的用户数到第一个一千万</a></strong></p>
...
<p align="center"><img src="/img/system-design/wU8x5Id.png"><br><strong><a href="http://www.slideshare.net/jboner/scalability-availability-stability-patterns/" target="_blank" rel="noopener">资料来源：可扩展性、可用性、稳定性、模式</a></strong></p>
...
<p align="center"><img src="/img/system-design/n16iOGk.png"><br><strong><a href="http://blog.grio.com/2015/11/sql-nosql-a-brief-history.html" target="_blank" rel="noopener">资料来源: SQL 和 NoSQL，一个简短的历史</a></strong></p>
...
<p align="center"><img src="/img/system-design/fNcl65g.png"><br><strong><a href="https://en.wikipedia.org/wiki/File:GraphDatabase_PropertyGraph.png" target="_blank" rel="noopener">资料来源：图数据库</a></strong></p>
...
<p align="center"><img src="/img/system-design/wXGqG5f.png"><br><strong><a href="https://www.infoq.com/articles/Transition-RDBMS-NoSQL/" target="_blank" rel="noopener">资料来源：从 RDBMS 转换到 NoSQL</a></strong></p>
...
##### 来源及延伸阅读：SQL 或 NoSQL {#来源及延伸阅读：SQL-或-NoSQL}
...
<p align="center"><img src="/img/system-design/Q6z24La.png"><br><strong><a href="http://horicky.blogspot.com/2010/10/scalable-system-design-patterns.html" target="_blank" rel="noopener">资料来源：可扩展的系统设计模式</a></strong></p>
...
<p align="center"><img src="/img/system-design/ONjORqk.png"><br><strong><a href="http://www.slideshare.net/tmatyashovsky/from-cache-to-in-memory-data-grid-introduction-to-hazelcast" target="_blank" rel="noopener">资料来源：从缓存到内存数据网格</a></strong></p>
...
<p align="center"><img src="/img/system-design/0vBc0hN.png"><br><strong><a href="http://www.slideshare.net/jboner/scalability-availability-stability-patterns/" target="_blank" rel="noopener">资料来源：可扩展性、可用性、稳定性、模式</a></strong></p>
...
<p align="center"><img src="/img/system-design/rgSrvjG.png"><br><strong><a href="http://www.slideshare.net/jboner/scalability-availability-stability-patterns/" target="_blank" rel="noopener">资料来源：可扩展性、可用性、稳定性、模式</a></strong></p>
...
<p align="center"><img src="/img/system-design/kxtjqgE.png"><br><strong><a href="http://www.slideshare.net/tmatyashovsky/from-cache-to-in-memory-data-grid-introduction-to-hazelcast">资料来源：从缓存到内存数据网格</a></strong></p>
...
<p align="center"><img src="/img/system-design/54GYsSx.png"><br><strong><a href="http://lethain.com/introduction-to-architecting-systems-for-scale/#platform_layer">资料来源：可缩放系统构架介绍</a></strong></p>
...
<p align="center"><img src="/img/system-design/5KeocQs.jpg"><br><strong><a href="http://www.escotal.com/osilayer.html">资料来源：OSI 7层模型</a></strong></p>
...
<p align="center"><img src="/img/system-design/JdAsdvG.jpg"><br><strong><a href="http://www.wildbunny.co.uk/blog/2012/10/09/how-to-make-a-multi-player-game-part-1/" target="_blank" rel="noopener">资料来源：如何制作多人游戏</a></strong></p>
...
为了确保高吞吐量，Web 服务器可以保持大量的 TCP 连接，从而导致高内存使用。在 Web 服务器线程间拥有大量开放连接可能开销巨大，消耗资源过多，也就是说，一个 [memcached](https://memcached.org/) 服务器。[连接池](https://en.wikipedia.org/wiki/Connection_pool) 可以帮助除了在适用的情况下切换到 UDP。
...
<p align="center"><img src="/img/system-design/yzDrJtA.jpg"><br><strong><a href="http://www.wildbunny.co.uk/blog/2012/10/09/how-to-make-a-multi-player-game-part-1" target="_blank" rel="noopener">资料来源：如何制作多人游戏</a></strong></p>
...
#### 来源及延伸阅读：TCP 与 UDP {#来源及延伸阅读：TCP-与-UDP}
...
### 远程过程调用协议（RPC） {#远程过程调用协议（RPC）}

<p align="center"><img src="/img/system-design/iF4Mkb5.png"><br><strong><a href="http://www.puncsky.com/blog/2016/02/14/crack-the-system-design-interview" target="_blank" rel="noopener">Source: Crack the system design interview</a></strong></p>
...
<p align="center"><strong><a href="https://apihandyman.io/do-you-really-know-why-you-prefer-rest-over-rpc" target="_blank" rel="noopener">资料来源：你真的知道你为什么更喜欢 REST 而不是 RPC 吗</a></strong></p>

#### 来源及延伸阅读：REST 与 RPC {#来源及延伸阅读：REST-与-RPC}
